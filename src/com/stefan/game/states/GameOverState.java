...
public class GameOverState extends GameState {
    ...
    private Sprite gameOver_photo;


    public GameOverState(GameStateManager gsm) {
        super(gsm);
        gameOver_photo=new Sprite("state/GameOver-state.png");
    }
    ...
    public void render(Graphics2D g) {
        Sprite.drawPhoto(g, gameOver_photo.getSpriteSheet(),new Vector2f(0,0),1280,720);
    }
}
